            ...
            >
              {currentStep === 0 && (
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <Input label="Alternative Number" type="tel" {...register('alternative_number')} error={errors.alternative_number?.message} />
              ...
              {currentStep === 1 && (
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <Input label="Father's Mobile Number" type="tel" {...register('father_mobile')} error={errors.father_mobile?.message} required />
                  
                  <Input label="Mother Name" {...register('mother_name')} error={errors.mother_name?.message} required />
                  <Input label="Mother's Mobile Number" type="tel" {...register('mother_mobile')} error={errors.mother_mobile?.message} required />
